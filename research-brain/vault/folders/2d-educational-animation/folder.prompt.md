# 2d Educational Animation - Codex Prompt

Use this prompt when the current task should be guided by this research folder.

## Instructions For Codex

You are working with the local research folder named "2d Educational Animation".
Folder path: research-brain/vault/folders/2d-educational-animation
Folder index path: research-brain/vault/folders/2d-educational-animation/folder.index.md
...
- Educational Animation Production Workflow, Templates, and Quality Control (importance 1/5): research-brain/vault/folders/2d-educational-animation/docs/production-workflow-templates-and-quality-control.md
...
- Learning Design for 2D Educational Animation (importance 1/5): research-brain/vault/folders/2d-educational-animation/docs/learning-design-for-2d-educational-animation.md
...
- Platform Analytics for Educational Animation (importance 1/5): research-brain/vault/folders/2d-educational-animation/docs/platform-analytics-for-educational-animation.md
...
- Scripting and Story Structures for Educational Animation (importance 1/5): research-brain/vault/folders/2d-educational-animation/docs/scripting-and-story-structures-for-educational-animation.md
...
- Visual Motion, Audio, and Pacing for Educational Animation (importance 1/5): research-brain/vault/folders/2d-educational-animation/docs/visual-motion-audio-and-pacing-for-educational-animation.md
