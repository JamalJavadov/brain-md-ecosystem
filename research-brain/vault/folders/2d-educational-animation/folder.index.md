...
Research-backed principles for designing 2D educational animation around cognitive load, attention guidance, segmentation, audience age, and meaningful use of motion.

## Routing Guide

Use this folder when the task needs 2d educational animation research, standards, examples, warnings, workflows, or reusable prompt patterns.
Strong routing terms: educational-animation, workflow, quality-control, educational animation workflow, animation storyboard template, educational video quality checklist, 2D explainer production, Production workflow, case studies, and practical tools, templates, and checklists, learning-design, cognitive-load, 2D educational animation, multimedia learning.
...
1. Educational Animation Production Workflow, Templates, and Quality Control - quality gate / diagnostic.
2. Scripting and Story Structures for Educational Animation - strategy / principles.
3. Platform Analytics for Educational Animation - workflow / process.
4. Learning Design for 2D Educational Animation - reference knowledge.
5. Visual Motion, Audio, and Pacing for Educational Animation - reference knowledge.
...
- Educational Animation Production Workflow, Templates, and Quality Control
  ...
  - Keywords: educational animation workflow, animation storyboard template, educational video quality checklist, 2D explainer production
  - Importance: 1/5
  - Evidence type: quality gate / diagnostic
  - Source section: Production workflow, case studies, and practical tools, templates, and checklists
...
- Learning Design for 2D Educational Animation
  ...
  - Keywords: 2D educational animation, multimedia learning, cognitive load in animation, signaling and segmentation
  - Importance: 1/5
  - Evidence type: reference knowledge
  - Source section: Evidence base and how attention and learning work in animated educational videos
  - Source import ID: `55aed051-ec7c-4c71-8e31-9ba479e4d104`
...
- Platform Analytics for Educational Animation
  ...
  - Keywords: educational video analytics, YouTube retention curve, TikTok educational video, Instagram Reels education
  - Importance: 1/5
  - Evidence type: workflow / process
  - Source section: Platform-specific guidance and what analytics should change in your process
  - Source import ID: `55aed051-ec7c-4c71-8e31-9ba479e4d104`
...
- Scripting and Story Structures for Educational Animation
  ...
  - Keywords: educational animation script, high retention explainer structure, animation storytelling framework
  - Importance: 1/5
  - Evidence type: strategy / principles
  - Source section: The structure and script of a high-retention educational animation
  - Source import ID: `55aed051-ec7c-4c71-8e31-9ba479e4d104`
...
- Visual Motion, Audio, and Pacing for Educational Animation
  ...
  - Keywords: educational animation pacing, animation visual hierarchy, captions in educational video, narration and sound design
  - Importance: 1/5
  - Evidence type: reference knowledge
  - Source section: Visual motion, narration, sound, and pacing
  - Source import ID: `55aed051-ec7c-4c71-8e31-9ba479e4d104`
  - Added: 2026-07-07T12:55:19.388Z
