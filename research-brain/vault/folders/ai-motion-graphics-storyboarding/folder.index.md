...
A production workflow for turning storyboards into Gemini/Veo prompt packets, with continuity rules, notation, templates, a SaaS example, and a pre-generation review checklist.

## Routing Guide

Use this folder when the task needs ai motion graphics storyboarding research, standards, examples, warnings, workflows, or reusable prompt patterns.
Strong routing terms: ai-video, prompting, storyboard to prompt, veo storyboard workflow, ai video review checklist, Designing Storyboards for Gemini Omni, Veo, and Other AI Video Tools; Workflow from Brief to Prompt; Templates, Example, and Final Review Standards, motion-graphics, saas-video, saas storyboard, ui animation storyboard, motion graphics text hierarchy, Storyboarding for Motion Graphics and SaaS UI Content.
...
1. AI Video Storyboard Workflow, Prompts, and Review - quality gate / diagnostic.
2. Storyboards as Control Documents for AI Motion Graphics - workflow / process.
3. Storyboard Layouts, Safe Zones, and Composition - reference knowledge.
4. Storyboard Vocabulary and Frame Anatomy - workflow / process.
5. Motion Graphics and SaaS UI Storyboarding - reference knowledge.
...
- AI Video Storyboard Workflow, Prompts, and Review
  ...
  - Source section: Designing Storyboards for Gemini Omni, Veo, and Other AI Video Tools; Workflow from Brief to Prompt; Templates, Example, and Final Review Standards
...
- Motion Graphics and SaaS UI Storyboarding
  ...
  - Source section: Storyboarding for Motion Graphics and SaaS UI Content
  - Source import ID: `55cd1458-1872-4e0a-b26f-57d6e0d0f2f5`
...
- Storyboard Layouts, Safe Zones, and Composition
  ...
  - Importance: 1/5
  - Evidence type: reference knowledge
  - Source section: Preparing Storyboard Images and Layout Systems
  - Source import ID: `55cd1458-1872-4e0a-b26f-57d6e0d0f2f5`
...
- Storyboard Vocabulary and Frame Anatomy
  ...
  - Source section: Storyboard Vocabulary and the Anatomy of a Professional Frame
  - Source import ID: `55cd1458-1872-4e0a-b26f-57d6e0d0f2f5`
...
- Storyboards as Control Documents for AI Motion Graphics
  ...
  - Keywords: ai motion graphics storyboard, storyboard control document, video pre-production
  - Importance: 1/5
  - Evidence type: workflow / process
  - Source section: Storyboards as the Control Layer for AI Motion Graphics
  - Source import ID: `55cd1458-1872-4e0a-b26f-57d6e0d0f2f5`
  - Added: 2026-07-06T19:53:35.518Z
