...
Professional Blender motion depends on sculpted F-Curves, stable constraint-led relationships, motivated camera movement, readable typography, causal transitions, and format-aware composition.

## Routing Guide

Use this folder when the task needs blender motion graphics production research, standards, examples, warnings, workflows, or reusable prompt patterns.
Strong routing terms: blender, animation, typography, Blender Graph Editor, F-Curves, camera travel and settle, Blender text objects, motion transitions, Animation, Camera Movement, Typography, Composition, and Transitions, geometry-nodes, workflow, Geometry Nodes instance first realize late.
...
1. Blender Geometry Nodes, Tools, and Workflow Organization - workflow / process.
2. Blender Animation, Camera, Typography, and Transitions - reference knowledge.
3. Blender Rendering, Compositing, Sound, and Delivery Workflow - workflow / process.
4. Blender Motion Graphics Production Baseline and Pipeline - workflow / process.
5. Blender Scene Planning, Materials, and Lighting for Motion Graphics - reference knowledge.
6. Blender Motion Graphics Blueprints, Checklists, and Glossary - quality gate / diagnostic.
...
- Blender Animation, Camera, Typography, and Transitions
  ...
  - Source section: Animation, Camera Movement, Typography, Composition, and Transitions
...
- Blender Geometry Nodes, Tools, and Workflow Organization
  ...
  - Source section: Geometry Nodes, Tools, Workflow Organization, and Add-Ons
  - Source import ID: `a0d5205e-a7ed-4c32-8425-68e0627c23c2`
...
- Blender Motion Graphics Blueprints, Checklists, and Glossary
  ...
  - Source section: Project Blueprints, Checklists, Learning Path, Glossary, and Final Framework
  - Source import ID: `a0d5205e-a7ed-4c32-8425-68e0627c23c2`
...
- Blender Motion Graphics Production Baseline and Pipeline
  ...
  - Importance: 1/5
  - Evidence type: workflow / process
  - Source section: Executive Summary and Current Blender Baseline; Motion Design Principles and the End-to-End Pipeline
  - Source import ID: `a0d5205e-a7ed-4c32-8425-68e0627c23c2`
...
- Blender Rendering, Compositing, Sound, and Delivery Workflow
  ...
  - Importance: 1/5
  - Evidence type: workflow / process
  - Source section: Rendering, Compositing, Sound, and Delivery
  - Source import ID: `a0d5205e-a7ed-4c32-8425-68e0627c23c2`
  - Added: 2026-07-06T19:56:46.881Z
- Blender Scene Planning, Materials, and Lighting for Motion Graphics
  ...
  - Importance: 1/5
  - Evidence type: reference knowledge
  - Source section: Scene Planning, Modeling, Materials, and Lighting
  - Source import ID: `a0d5205e-a7ed-4c32-8425-68e0627c23c2`
  - Added: 2026-07-06T19:56:46.883Z
