...
Use this folder when the task needs product video material realism research, standards, examples, warnings, workflows, or reusable prompt patterns.
Strong routing terms: ai-video, quality-control, material-failures, plastic AI look, uniform gloss, floating object look, random highlight flicker, Common AI material mistake table, google-flow, veo, ai-video-workflow, motion-only image-to-video prompt.
...
1. Product Material Realism Prompt Templates - template / reusable pattern.
2. Material Realism Review Checklist for Product Video - quality gate / diagnostic.
3. Google Flow, Veo, and Gemini Workflow for Product Material Realism - template / reusable pattern.
4. Material Realism Principles for AI Product Video Prompts - reference knowledge.
5. Material-Specific Prompting Guide for Product Videos - template / reusable pattern.
6. Lighting, Camera, and Reflections for Material Realism - template / reusable pattern.
...
- Common AI Product Material Failures and Fixes
  ...
  - Source section: Common AI material mistake table
...
- Google Flow, Veo, and Gemini Workflow for Product Material Realism
  ...
  - Source section: Google Flow, Gemini Omni, and Veo Workflow
  - Source import ID: `0ddc16d4-c753-46db-bcf6-2f6811df937e`
...
- Lighting, Camera, and Reflections for Material Realism
  ...
  - Importance: 1/5
  - Evidence type: template / reusable pattern
  - Source section: Lighting and Camera for Material Realism
  - Source import ID: `0ddc16d4-c753-46db-bcf6-2f6811df937e`
...
- Material Realism Principles for AI Product Video Prompts
  ...
  - Source section: Core Material Realism Principles
  - Source import ID: `0ddc16d4-c753-46db-bcf6-2f6811df937e`
...
- Material Realism Review Checklist for Product Video
  ...
  - Importance: 1/5
  - Evidence type: quality gate / diagnostic
  - Source section: Final Material Realism Checklist
  - Source import ID: `0ddc16d4-c753-46db-bcf6-2f6811df937e`
...
- Material-Specific Prompting Guide for Product Videos
  ...
  - Importance: 1/5
  - Evidence type: template / reusable pattern
  - Source section: Material-Specific Prompt Guide
  - Source import ID: `0ddc16d4-c753-46db-bcf6-2f6811df937e`
...
- Product Material Realism Prompt Templates
  ...
  - Keywords: product video prompt template, negative constraints template, perfume bottle material prompt, ARTIZ.AZ workflow template
  - Importance: 1/5
  - Evidence type: template / reusable pattern
  - Source section: Prompt Templates and Common Mistakes
  - Source import ID: `0ddc16d4-c753-46db-bcf6-2f6811df937e`
  - Added: 2026-07-06T19:39:16.701Z
